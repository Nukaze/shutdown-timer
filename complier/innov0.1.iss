...
[Files]
Source: "C:\GitHubRepo\shutdown-timer\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\GitHubRepo\shutdown-timer\asset\*"; DestDir: "{app}/asset"; Flags: ignoreversion recursesubdirs createallsubdirs
